[FREE] 5/5 scans remaining this week
  ...
  → 完成 Pi 全局檢查
  → 正在檢查 MCP 依賴...
  → 完成 MCP 檢查（0 個發現，0 個工具）
> **[DANGER] 建議：不要安裝**
>
> **目標**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest`
...
> **掃描目標**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest`  
> **掃描文件數**: 2640  
> **發現問題數**: 34（🔴 14 | 🟠 20 | 🟡 0 | 🟢 0）
...
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\docs\superpowers\plans\2026-08-02-lean-mode-implementation.md:22`
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\docs\superpowers\plans\2026-08-02-lean-mode-implementation.md:328`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\docs\superpowers\specs\2026-08-02-lean-mode-design.md:36`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\docs\superpowers\specs\2026-08-02-lean-mode-design.md:286`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\agent-bash-pty.ts:41`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:255`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:257`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:269`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:274`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:278`
- **命中**: `function ensureAgent`
- **說明**: 自動修改全局 AGENTS.md 或 agents/*.md（AI Agent 配置檔）
這是最高風險的攻擊之一：
- 持久性：修改後不會隨項目刪除而消失
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:315`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:347`
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:16`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:258`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:270`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-subagent-delegation.ts:275`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\global-agent-mode.ts:20`
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\resolve-pi-cli.ts:98`
- **命中**: `function ensureSubagent`
- **說明**: 自動修改全局 AGENTS.md 或 agents/*.md（AI Agent 配置檔）
這是最高風險的攻擊之一：
- 持久性：修改後不會隨項目刪除而消失
...
- **規則 ID**: `path-agents-md-ref`
- **嚴重度**: 🟠 HIGH | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\web-settings.ts:98`
- **命中**: `~/.pi/agent/AGENTS.md`
- **說明**: 代碼中引用全局 AGENTS.md
- **建議**: 確認代碼意圖。如果目的是讀取可以，但要避免自動寫入。
如需修改全局 Agent 行為，要求用戶明確同意。
...
- **規則 ID**: `path-agents-md-write`
- **嚴重度**: 🔴 CRITICAL | **置信度**: 🔴 high
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\first-party\subagents\index.ts:67`
...
- **嚴重度**: 🟠 HIGH | **置信度**: 🟡 medium
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\app\api\skills\route.ts:42`
...
- **嚴重度**: 🟠 HIGH | **置信度**: 🟡 medium
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\ensure-builtin-packages.ts:58`
...
- **規則 ID**: `implicit-agent-function`
- **嚴重度**: 🟠 HIGH | **置信度**: 🟡 medium
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\model-runtime.ts:26`
...
- **規則 ID**: `implicit-agent-function`
- **嚴重度**: 🟠 HIGH | **置信度**: 🟡 medium
- **位置**: `C:\Users\Administrator\AppData\Local\Temp\pi-web-scan-latest\lib\permission-policy.ts:210`
...
*本報告由 skill-safety-guard v1.5.0 自動生成*  
